...
const FeedbackThanks = forwardRef(function FeedbackThanks(
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 rounded-full bg-purple-50/50 py-1 pr-3 pl-1.5 text-sm text-purple-900 ring-1 ring-purple-500/20 ring-inset dark:bg-purple-500/5 dark:text-purple-200 dark:ring-purple-500/30">
