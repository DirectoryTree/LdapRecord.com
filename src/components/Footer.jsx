...
function PageNavigation() {
    ...
    // Get navigation for current package and version
    const navigation = getNavigation(currentPackage, currentVersion);
    ...
    return (
        <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 sm:flex-row dark:border-white/5">
            ...
            <div className="flex gap-4">
                <SocialLink href="https://x.com/ste_bau" icon={XIcon}>
                    Follow us on X
                </SocialLink>
