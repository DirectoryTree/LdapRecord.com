...
function ResourcePattern({ mouseX, mouseY, ...gridProps }) {
    ...
    return (
        <div className="pointer-events-none">
            ...
            <motion.div
                className="absolute inset-0 rounded-2xl bg-linear-to-r from-[#E6D7F0] to-[#F0E6F7] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#2D1B3D] dark:to-[#3D2B4D]"
                style={style}
            />
            <motion.div
