    ...
    return (
        <button
            ...
            className={clsx(
                ...
                copied
                    ? 'bg-purple-400/10 ring-1 ring-purple-400/20 ring-inset'
...
function CodePanelHeader({ tag, label }) {
    ...
    return (
        <div className="flex h-9 items-center gap-2 border-y border-t-transparent border-b-zinc-200/50 bg-zinc-100 px-4 dark:border-b-white/5 dark:bg-white/1">
            {tag && (
                <div className="flex">
...
function CodePanel({ children, tag, label, code }) {
    ...
    return (
        <div className="group bg-zinc-50 dark:bg-white/2.5">
...
function CodeGroupHeader({ title, children, selectedIndex }) {
    ...
    return (
        <div className="flex min-h-[calc(--spacing(12)+1px)] flex-wrap items-start gap-x-4 border-b border-zinc-200 bg-zinc-100 px-4 dark:border-zinc-700 dark:bg-zinc-800">
            {title && (
                        ...
                        <Tab
                            className={clsx(
                                ...
                                childIndex === selectedIndex
                                    ...
                                    : 'border-transparent text-zinc-600 hover:text-zinc-700 dark:text-zinc-400 dark:hover:text-zinc-300',
                            )}
                        >
                            {getPanelTitle(
...
export function CodeGroup({ children, title, ...props }) {
    ...
    let containerClassName =
        'my-6 overflow-hidden rounded-2xl bg-zinc-50 ring-1 ring-zinc-200 dark:bg-zinc-900 dark:ring-white/10';
    let header = (
        <CodeGroupHeader
            title={title}
