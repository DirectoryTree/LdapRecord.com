...
import { parsePackageAndVersion } from '@/components/VersionSelector';
...
function SearchResult({
    ...
    // Parse package and version from the result URL to get the correct navigation
    const { package: resultPackage, version: resultVersion } =
        parsePackageAndVersion(result.url);
    const navigation = getNavigation(resultPackage, resultVersion);
