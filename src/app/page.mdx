...
<div className="not-prose mt-6 mb-16 flex gap-3">
    <Button href="/docs/core/v4" arrow="right">
        <>Core Documentation</>
    </Button>

    <Button href="/docs/laravel/v4" variant="outline">
        <>Laravel Integration</>
    </Button>
</div>
...
<div className="not-prose mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
    <div className="group relative rounded-xl border border-zinc-200 p-6 dark:border-zinc-800">
        ...
        <div className="mt-4">
            <Button href="/docs/core/v4" variant="text" arrow="right">
    ...
    <div className="group relative rounded-xl border border-zinc-200 p-6 dark:border-zinc-800">
        ...
        <div className="mt-4">
            <Button href="/docs/laravel/v4" variant="text" arrow="right">
